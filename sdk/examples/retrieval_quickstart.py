...
def main() -> None:
    ...
    docs = [
        {
            ...
            "raw_text": "Knowledge² organizes content into corpora and builds dense and sparse indexes for hybrid retrieval.",
    ...
    client.upload_documents_batch_and_wait(corpus["id"], docs, auto_index=False)
